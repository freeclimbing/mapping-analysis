 ...
 */
public class MergeGeoStepFunction {
  private static final Logger LOG = Logger.getLogger(MergeGeoStepFunction.class);
  ...
  public MergeGeoStepFunction(DataSet<MergeGeoTriplet> workset,
