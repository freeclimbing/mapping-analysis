...
//    QualityUtils.printGeoQuality(clusters, config); // TODO test quality
  ...
  public void incrementalVertexAdditionClusteringTest() throws Exception {
    ...
    assertEquals(2828, resultingVerticesList.size());
  ...
  public void incrementalGeoHungarianClusteringTest() throws Exception {
     ...
     */
    resultingVerticesList = Lists.newArrayList();
//    HashSet<Long> check = Sets.newHashSet();
    for (Vertex<Long, ObjectMap> representative : representatives) {
//      LOG.info("result: " + representative.toString());
//      for (Long singleContainedVertex : representative.getValue().getVerticesList()) {
//        if (check.contains(singleContainedVertex)) {
//          LOG.info("already contained: " + representative.toString());
//        } else {
//          check.add(singleContainedVertex);
//        }
//      }
